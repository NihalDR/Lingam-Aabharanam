        ...
        <div>
          <div className="flex items-center mb-4">
            <Avatar className="h-10 w-10 mr-2">
              <AvatarImage
                src="/lingam-uploads/cad02e43-afa0-4b15-807d-e6aeaa0b68c3.png"
        ...
        <div className="container mx-auto px-4 sm:px-6 py-4">
          <div className="flex flex-col md:flex-row md:justify-between items-center">
            ...
            <div className="flex space-x-4 mt-2 md:mt-0">
              <Link to="/privacy-policy" className="text-sm text-gray-400 hover:text-brand-gold">
                Privacy Policy
              </Link>
              <Link to="/terms-of-service" className="text-sm text-gray-400 hover:text-brand-gold">
                Terms of Service
              </Link>
            </div>
          </div>
