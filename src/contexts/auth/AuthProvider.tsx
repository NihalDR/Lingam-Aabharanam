...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const signup = async (email: string, password: string, name?: string, phone?: string) => {
    ...
    try {
      ...
      // Note: We're not creating a profile in the profiles table since it doesn't exist
      // In a real implementation, you would create the profiles table and insert user data here
      console.log('[AuthContext] User signup successful:', data.user?.id);
