...
import { LineChart, ActivityItem } from '@/components/AdminDashboardCharts';
import { 
  Package, 
  CalendarDays, 
  ChevronRight,
...
const AdminDashboard = () => {
  ...
  // Data for appointment trends visualization
  ...
  useEffect(() => {
    const loadData = async () => {
      setIsLoading(true);
      try {
        // Fetch real data from localStorage services
          ...
          <CardContent className="space-y-4">
            {isLoading ? (
              ...
              <div className="text-center py-6 text-gray-500">
                ...
                <p className="text-sm mt-2">As you add products and receive appointments, activities will appear here</p>
              </div>
            )}
          </CardContent>
        </Card>
